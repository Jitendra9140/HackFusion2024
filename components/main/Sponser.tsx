      ...
      <div className="">
         ...
         <div data-aos="zoom-in" className="flex flex-row flex-wrap gap-4 justify-center items-center">
           <div className="w-[200px] h-[40px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser1.png" className='w-[300px] h-[40px]' alt="" />
           </div>
           <div className="w-[200px] h-[200px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser2.png" className='w-[300px] h-[200px]' alt="" />
           </div>
           <div className="w-[300px] h-[100px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser3.png" className='w-[300px] h-[100px]' alt="" />
           </div>
         </div>
      </div>
      <div data-aos="zoom-in" className=" flex flex-col gap-5">
         ...
         <div className="flex flex-row flex-wrap gap-4 justify-center items-center">
           ...
           <div className="w-[180px] h-[180px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser6.png" className='w-[180px] h-[180px]' alt="" />
           </div>
           <div className="w-[150px] h-[150px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser3.png" className='w-[150px] h-[150px]' alt="" />
           </div>
           <div className="w-[300px] h-[100px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser1.png" className='w-[300px] h-[100px]' alt="" />
           </div>
         </div>
      </div>
      <div data-aos="zoom-in" className=" flex flex-col gap-5">
         ...
         <div className="flex flex-row gap-4 flex-wrap justify-center items-center">
           <div className="w-[250px] h-[40px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser1.png" className='w-[250px] h-[40px]' alt="" />
           </div>
           <div className="w-[250px] h-[40px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser7.png" className='w-[250px] h-[40px]' alt="" />
           </div>
           <div className="w-[250px] h-[80px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser4.png" className='w-[250px] h-[80px]' alt="" />
           </div>
           <div className="w-[250px] h-[40px]  bg-white border rounded-md">
            <Image width={100} height={20} src="/Sponser8.png" className='w-[250px] h-[40px]' alt="" />
           </div>
         </div>
      </div>
    </div> 
